...
using Personal.Portable.WebApi.Models;
using Personal.Portable.WebApi.Providers;
using Personal.Portable.WebApi.Results;

namespace Personal.Portable.WebApi.Controllers
{
    [Authorize]
